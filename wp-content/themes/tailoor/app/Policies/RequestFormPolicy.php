...
class RequestFormPolicy extends AbstractPolicy
{
    ...
    protected array $freeEmailServicesDomains = [
        '0-mail.com',
        '027168.com',
        '0815.su',
        '0sg.net',
        ...
        foreach ($request->except('requestForm_nonce', '_wp_http_referer') as $key => $value) {
            switch ($key) {
                ...
                case 'email':
                    ...
                    // Accepting only business work email addresses
                    if (is_string($value)) {
                        $domain = substr(strrchr($value, "@"), 1);
                        if (in_array($domain, $this->freeEmailServicesDomains)) {
                            $errors[] = __('Please enter your business email address.');
                            $value = null;
                        }
                    }
