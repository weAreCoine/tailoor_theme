<div
  ...
  x-init="$watch('visible', value => onChangeVisibility(value)); body = document.querySelector('body'); $el.classList.remove('hidden')"
  data-name="{{$name}}"
  ...
  class="fixed z-[9999] top-0 left-0 h-screen w-screen bg-mirage/40 backdrop-blur flex flex-col justify-start items-center cursor-pointer sm:p-6 duration-300 peer-aria-hidden:=">
  <div
